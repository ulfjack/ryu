...
RYU_INLINE uint64_t double_pow5_table(size_t index)
{
  assert(index < RYU_POW5_TABLE_SIZE);
  static const uint64_t table[RYU_POW5_TABLE_SIZE] = {
...
RYU_INLINE const uint64_t* double_pow5_split2(size_t index)
{
  assert(index < 13);
  static const uint64_t table[13][2] = {
...
RYU_INLINE uint32_t pow5_offsets(size_t index)
{
  assert(index < 13);
  static const uint32_t table[13] = {
...
RYU_INLINE const uint64_t* double_pow5_inv_split2(size_t index)
{
  assert(index < 13);
  static const uint64_t table[13][2] = {
...
RYU_INLINE uint32_t pow5_inv_offsets(size_t index)
{
  assert(index < 20);
...
RYU_INLINE void double_computePow5(const uint32_t i, uint64_t* const result) {
...
// Computes 5^-i in the form required by Ryu, and stores it in the given pointer.
RYU_INLINE void double_computeInvPow5(const uint32_t i, uint64_t* const result) {
